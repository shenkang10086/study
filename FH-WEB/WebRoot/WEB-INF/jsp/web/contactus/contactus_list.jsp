...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="contactus/list.do" method="post" name="Form" id="Form">
						<!-- 检索  -->
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>contactus/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 410;
		...
		function del(Id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=basePath%>contactus/delete.do?CONTACTUS_ID="+Id+"&tm="+new Date().getTime();
